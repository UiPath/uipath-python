...
def test_init_script_detection(runner: CliRunner, temp_dir: str) -> None:
...
def test_init_with_entrypoint(runner: CliRunner, temp_dir: str) -> None:
...
def test_init_error_handling(runner: CliRunner, temp_dir: str) -> None:
