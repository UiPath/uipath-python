        ...
        match trigger.trigger_type:
            ...
            case UiPathResumeTriggerType.JOB:
                if trigger.item_key:
                    ...
                    if trigger.trigger_name == UiPathResumeTriggerName.JOB_RAW:
                        return job
...
class UiPathResumeTriggerCreator:
    ...
    def _determine_trigger_name(self, value: Any) -> UiPathResumeTriggerName:
        ...
        if isinstance(value, (InvokeProcessRaw, WaitJobRaw)):
            return UiPathResumeTriggerName.JOB_RAW
        if isinstance(
    ...
    async def _handle_ephemeral_index_job_trigger(
        ...
        Args:
            value: The suspend value (CreateEphemeralIndex or WaitEphemeralIndex)
            resume_trigger: The resume trigger to populate
