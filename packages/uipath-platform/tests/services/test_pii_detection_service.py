...
def service(
    ...
    return PiiDetectionService(config=config, execution_context=execution_context)
...
class TestPiiDetectionService:
    """Test PiiDetectionService functionality."""
    ...
    class TestDetectPii:
        ...
        def test_returns_typed_response(
            ...
            httpx_mock.add_response(
                url=f"{base_url}{org}{tenant}/llmopstenant_/api/pii-detection",
                status_code=200,
    ...
    class TestDetectPiiAsync:
        ...
        async def test_url_is_tenant_scoped(
            ...
            assert "/llmopstenant_/api/pii-detection" in captured_request.url.path
