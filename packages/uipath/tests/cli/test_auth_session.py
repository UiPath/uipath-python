...
class TestAuthSessionRefreshToken:
    ...
    def test_refresh_different_domains(
        ...
        with (
            ...
            patch(
                "uipath._cli._auth._auth_session.IdentityService.refresh_access_token",
            ...
            result = auth_session.refresh_access_token("test_refresh_token")
    ...
    def test_refresh_with_uipath_url_env(
        self,
        env_var_url,
        environment,
        expected_domain,
    ...
    def test_refresh_unauthorized(self, mock_auth_config):
        import httpx
        ...
        with (
            ...
            with pytest.raises((SystemExit, Exception)):
                auth_session.refresh_access_token("test_refresh_token")

            mock_console.error.assert_called_once_with("Unauthorized")

    def test_refresh_server_error(self, mock_auth_config):
        import httpx
    ...
    def test_refresh_success_response_format(self, mock_auth_config, sample_token_data):
        with (
            patch(
                "uipath._cli._auth._oidc_utils.OidcUtils.get_auth_config",
                return_value=mock_auth_config,
    ...
    def test_refresh_malformed_domain_handling(
        ...
        for uipath_url, environment, expected_domain in test_cases:
            with (
                ...
                assert mock_refresh.call_args.kwargs["domain"] == expected_domain
    ...
    def test_refresh_auth_scenarios_integration(
        self,
        scenario_name,
        env_vars,
        environment,
...
class TestAuthSessionEnsureValidToken:
    ...
    def test_ensure_valid_token_refresh_flow_different_domains(
        ...
        with (
            ...
            auth_session.ensure_valid_token()
    ...
    def test_ensure_valid_token_skips_refresh_when_not_expired(self, mock_auth_config):
    ...
    def test_ensure_valid_token_missing_refresh_token_raises(self, mock_auth_config):
