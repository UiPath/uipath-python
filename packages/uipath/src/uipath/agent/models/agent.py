...
# solution_folder placeholder needs to be converted to None so that inline guardrail escalations can be resolved just-in-time
...
"""A folder field that may carry the folder name or solution-folder placeholder which is parsed as ``None``."""
