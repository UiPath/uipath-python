...
from uipath.eval._models._evaluation_set import EvaluationItem, LLMMockingStrategy
from uipath.eval.mocks.mocker import Mocker, R, T, UiPathMockingNoMatcherError
    ...
    async def response(
        ...
        if function_name in [
            ...
            try:
                ...
                logger.error(
                    f"Exception occurred while generating mocked response. {e}"
                )
