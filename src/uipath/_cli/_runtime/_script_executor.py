...
class ScriptExecutor:
    def __init__(self, context: UiPathRuntimeContext, entrypoint: Optional[str]):
    ...
    async def _execute_python_script(self) -> Any:
        script_path = self.entrypoint
        input_data = self.context.input_json
            ...
            if hasattr(module, func_name):
                ...
                if input_type != inspect.Parameter.empty and (
                    ...
                    try:
                        ...
                        typed_input = self._convert_to_class(input_data, valid_type)  # type: ignore
                        result = (
