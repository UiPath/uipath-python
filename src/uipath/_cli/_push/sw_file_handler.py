...
class SwFileHandler:
    ...
    async def upload_source_files(self, config_data: dict[str, Any]) -> None:
        ...
        # Handle evaluation files using new structure (evaluators/, datasets/)
        await self._process_evaluation_uploads(structure)
