...
class FieldMetadata(BaseModel):
    ...
    reference_entity: Optional["EntityGetByIdResponse"] = Field(
        default=None, alias="referenceEntity"
    )
    reference_choiceset: Optional["EntityGetByIdResponse"] = Field(
...
class EntityGetByIdResponse(BaseModel):
    ...
    storage_size_in_mb: Optional[int] = Field(default=None, alias="storageSizeInMB")
    used_storage_size_in_mb: Optional[int] = Field(
...
EntityGetByIdResponse.model_rebuild()
