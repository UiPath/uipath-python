...
class JobsService(FolderContext, BaseService):
    ...
    @traced(name="jobs_create_job_attachment", run_type="uipath")
    def create_job_attachment(
        self,
        *,
        name: str,
        ...
        Examples:
            ...
            attachment_id = client.jobs.create_job_attachment(
                name="document.pdf",
    ...
    @traced(name="jobs_create_job_attachment", run_type="uipath")
    async def create_job_attachment_async(
        self,
        *,
        name: str,
        content: Optional[Union[str, bytes]] = None,
        ...
        Examples:
            ...
            async def main():
                # Create attachment from file and link to job
                attachment_id = await client.jobs.create_job_attachment_async(
                    name="document.pdf",
                    source_path="path/to/local/document.pdf",
                    job_key="38073051"
                )
