...
@pytest.fixture
def extraction_response(documents_tests_data_path: Path) -> dict:
    with open(documents_tests_data_path / "extraction_response.json", "r") as f:
        return json.load(f)


@pytest.fixture
def create_validation_action_response(documents_tests_data_path: Path) -> dict:
    with open(
...
@pytest.fixture
def validated_result(documents_tests_data_path: Path) -> dict:
    with open(
...
class TestDocumentsService:
    ...
    def test_extract_with_both_file_and_file_path_provided(
        self,
        service: DocumentsService,
    ):
        # ACT & ASSERT
    ...
    def test_extract_with_neither_file_nor_file_path_provided(
        self,
        service: DocumentsService,
    ):
        # ACT & ASSERT
    ...
    def test_extract_with_wrong_project_name(
        self,
        httpx_mock: HTTPXMock,
        service: DocumentsService,
        base_url: str,
    ...
    def test_extract_with_wrong_tag(
        self,
        httpx_mock: HTTPXMock,
        service: DocumentsService,
        base_url: str,
    ...
    def test_create_validation_action(
        self,
        httpx_mock: HTTPXMock,
        service: DocumentsService,
        base_url: str,
        ...
        tenant: str,
        extraction_response: dict,
        create_validation_action_response: dict,
    ):
        # ARRANGE
        project_id = str(uuid4())
        operation_id = str(uuid4())
    ...
    def test_wait_for_operation_failed(
        self,
        service: DocumentsService,
    ):
        # ARRANGE
