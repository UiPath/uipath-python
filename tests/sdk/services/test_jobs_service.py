...
class TestJobsService:
    ...
    def test_create_job_attachment_with_job(
        ...
        # Act
        result = service.create_job_attachment(
    ...
    def test_create_job_attachment_with_job_context(
        ...
        # Act
        result = service.create_job_attachment(name=name, content=content)
    ...
    async def test_create_job_attachment_async_with_job(
        ...
        # Act
        result = await service.create_job_attachment_async(
            name=name, content=content, job_key=job_key
        )
    ...
    async def test_create_job_attachment_async_no_job(
        ...
        # Act
        result = await service.create_job_attachment_async(name=name, content=content)
