...
from uipath._cli._evals.mocks.strategy import LLMMockingStrategy, MockitoMockingStrategy
...
class TestIsToolSimulated:
    ...
    def test_returns_false_when_mocking_strategy_is_none(self):
        ...
        set_execution_context(
            evaluation.mocking_strategy, _mock_span_collector, "test-execution-id"
        )
