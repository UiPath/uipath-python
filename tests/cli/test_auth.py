...
class TestAuth:
    ...
    def test_auth_scenarios(
        ...
        with (
            ...
            mock_portal_service.return_value.__enter__.return_value.select_tenant.return_value = {
                "tenant_id": "tenant-id",
    ...
    def test_auth_with_tenant_flag(self):
        ...
        with (
            ...
            portal.retrieve_tenant.return_value = {
                "tenant_id": "tenant-id",
                "organization_id": "org-id",
            }
            ...
            portal.retrieve_tenant.assert_called_once_with("MyTenantName")
            assert not portal.select_tenant.called
