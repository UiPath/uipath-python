...
def test_buckets_delete_with_confirm(runner, mock_client, mock_env_vars):
    ...
    mock_bucket.id = "123"
    mock_bucket.delete = MagicMock()  # Mock the resource delete method
    ...
    mock_bucket.delete.assert_called_once()  # Assert bucket.delete() was called
...
def test_buckets_delete_dry_run(runner, mock_client, mock_env_vars):
    ...
    mock_bucket.delete.assert_not_called()  # Assert bucket.delete() was not called
