...
class TestExtractionFunctions:
    ...
    @pytest.fixture
    def spans_with_json_input(self) -> list:
    ...
    @pytest.fixture
    def spans_with_dict_input(self) -> list:
    ...
    def test_extract_tool_calls_names_with_tools(self, sample_spans: list) -> None:
    ...
    def test_extract_tool_calls_names_preserves_order(self, sample_spans: list) -> None:
    ...
    def test_extract_tool_calls_with_string_input(self, sample_spans: list) -> None:
    ...
    def test_extract_tool_calls_with_dict_input(
        self, spans_with_dict_input: list
    ) -> None:
    ...
    def test_extract_tool_calls_with_invalid_input(
        self, spans_with_invalid_input: list
    ) -> None:
    ...
    def test_extract_tool_calls_outputs_with_tools(self, sample_spans: list) -> None:
    ...
    def test_all_extraction_functions_consistent(self, sample_spans: list) -> None:
