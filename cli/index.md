...
| Name                | Type           | Description                                                                                                                                                                            | Default  |
| ------------------- | -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| `--type`            | choice (`auto` | `function`                                                                                                                                                                             | `agent`) |
| `--agent-framework` | text           | Agent framework to scaffold with, named by its package (e.g. `uipath-langchain`). Only valid together with `--type agent`; picks which framework scaffolds when several are installed. | None     |
| `--help`            | boolean        | Show this message and exit.                                                                                                                                                            | `False`  |
...
uipath new my-function --type function⠋ Creating new project my-function in current directory ...\
...
uv add uipath-langchainResolved 42 packages in 1.2s\
Installed 42 packages in 0.8s\
uipath new my-agent --type agent⠋ Creating new agent my-agent in current directory ...\
✓ Created 'main.py' file.\
