...
# Pick the package that matches your framework:# uipath-langchain - LangChain / LangGraph# uipath-openai-agents - OpenAI Agents SDK# uipath-llamaindex - LlamaIndex# uipath-pydantic-ai - PydanticAI# uipath-google-adk - Google ADK# uipath-agent-framework - UiPath Agent Framework# uipath-claude-sdk - Claude Agent SDKuv add uipath-langchainResolved 42 packages in 1.2s

Installed 42 packages in 0.8s

# Pick the package that matches your framework:# uipath-langchain - LangChain / LangGraph# uipath-openai-agents - OpenAI Agents SDK# uipath-llamaindex - LlamaIndex# uipath-pydantic-ai - PydanticAI# uipath-google-adk - Google ADK# uipath-agent-framework - UiPath Agent Framework# uipath-claude-sdk - Claude Agent SDKpip install uipath-langchainSuccessfully installed uipath-langchain
...
Selected tenant: Tenant1\
✓ Authentication successful.\
uipath new my-function --type function✓ Created 'main.py' file.\
