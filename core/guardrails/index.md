...
| `guardrail`  | `Guardrail` | A guardrail instance used for validation. Must be an instance of BuiltInValidatorGuardrail. Custom guardrails are not supported. | *required*                                                                                             |

Returns:

| Name                               | Type                        | Description                                                                                   |
| ---------------------------------- | --------------------------- | --------------------------------------------------------------------------------------------- |
| `BuiltInGuardrailValidationResult` | `GuardrailValidationResult` | The outcome of the guardrail evaluation, containing whether validation passed and the reason. |
