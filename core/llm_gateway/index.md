...
| `model`             | `str`                                              | The model to use for chat completion. Defaults to ChatModels.gpt_4o_mini_2024_07_18. Available models are defined in the ChatModels class.                                                                                                                                                      | `gpt_4o_mini_2024_07_18` |
