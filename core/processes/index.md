...
| `entry_point_path`    | \`str            | None\`                              | The workflow to run, as a package-relative path. Omitted from the request when unset, which runs the release's configured entry point. |
